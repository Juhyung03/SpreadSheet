...
// 'spreadsheet'배열 초기화, 각 셀에 대한 'Cell' 객체를 생성하여 저장, 
// 'drawSheet'함수를 호출하여 스프레드시트를 렌더링
...
function createCellEl(cell){
    ...
    //타이핑 시 텍스트를 cell 객체의 data 속성 값으로 넣어주기
...
function handleCellClick(cell){
    ...
    //console.log('clicked cell', cell, columnHeader, rowHeader);
    //셀 상태 나타내기
